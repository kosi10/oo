...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.to = JSON.parse(localStorage.getItem("pickedUser"));
            var toId = JSON.parse(localStorage.getItem("pickedUser")).id;
        ...
        methods: {
            ...
            newMessageSubmit(){
                var message = {
                    ...
                    "toid": JSON.parse(localStorage.getItem("pickedUser")).id
                }
